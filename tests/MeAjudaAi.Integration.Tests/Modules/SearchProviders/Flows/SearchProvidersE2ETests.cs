...
namespace MeAjudaAi.Integration.Tests.Modules.SearchProviders.Flows;
...
public class SearchProvidersE2ETests : BaseApiTest
{
    ...
    public async Task Search_ByServiceAndRadius_ShouldReturnNearbyProviders()
    {
        ...
        var result = System.Text.Json.JsonSerializer.Deserialize<PagedResult<ModuleSearchableProviderDto>>(responseBody, SerializationDefaults.Api);
