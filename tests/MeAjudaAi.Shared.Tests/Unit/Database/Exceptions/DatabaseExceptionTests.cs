...
namespace MeAjudaAi.Shared.Tests.Unit.Database.Exceptions;

[Trait("Category", "Unit")]
[Trait("Component", "Database")]
public class DatabaseExceptionTests
{
    #region UniqueConstraintException
    ...
    #region NotNullConstraintException
    ...
    #region ForeignKeyConstraintException
    ...
    #region PostgreSqlExceptionProcessor
    ...
    [Fact]
    public void ProcessException_WithNonPostgresException_ShouldReturnOriginal()
    {
        // Arrange
    ...
    [Fact]
    public void ProcessException_WithInnerExceptionNull_ShouldHandleGracefully()
    {
        // Arrange
