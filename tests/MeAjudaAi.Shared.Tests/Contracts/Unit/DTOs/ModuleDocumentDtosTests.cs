...
public class ModuleDocumentDtosTests
{
    ...
    public void ModuleDocumentDto_ShouldSerializeAndDeserialize()
    {
        ...
        var dto = new ModuleDocumentDto(
            Guid.NewGuid(), Guid.NewGuid(), "CPF", "documento.pdf",
            "https://storage.example.com/documento.pdf", "Verified",
            DateTime.UtcNow, DateTime.UtcNow.AddHours(1), null, null);
    ...
    public void ModuleDocumentDto_WithRejectedStatus_ShouldIncludeRejectionReason()
    {
        // Arrange
        var dto = new ModuleDocumentDto(
            Guid.NewGuid(), Guid.NewGuid(), "RG", "documento.pdf",
            "https://storage.example.com/documento.pdf", "Rejected",
            DateTime.UtcNow, null, "Documento ilegível", null);
    ...
    public void ModuleDocumentDto_WithOcrData_ShouldSerializeOcrData()
    {
        ...
        var dto = new ModuleDocumentDto(
            Guid.NewGuid(), Guid.NewGuid(), "CPF", "cpf.pdf",
            "https://storage.example.com/cpf.pdf", "Verified",
            DateTime.UtcNow, DateTime.UtcNow, null, ocrData);
    ...
    public void ModuleDocumentDto_ShouldSupportMultipleDocumentTypes(string documentType)
    {
        // Arrange & Act
        var dto = new ModuleDocumentDto(
            Guid.NewGuid(), Guid.NewGuid(), documentType, $"{documentType}.pdf",
            $"https://storage.example.com/{documentType}.pdf", "Uploaded", DateTime.UtcNow);
    ...
    public void ModuleDocumentDto_ShouldSupportAllStatuses(string status)
    {
        // Arrange & Act
        var dto = new ModuleDocumentDto(
            Guid.NewGuid(), Guid.NewGuid(), "CPF", "doc.pdf",
            "https://storage.example.com/doc.pdf", status, DateTime.UtcNow);
    ...
    {
        // Arrange
        var dto = new DocumentStatusCountDto(100, 42, 35, 18, 5);
    ...
    {
        // Arrange
        var dto = new DocumentStatusCountDto(0, 0, 0, 0, 0);
    ...
    {
        // Arrange
        var dto = new DocumentStatusCountDto(100, 25, 50, 15, 10);
