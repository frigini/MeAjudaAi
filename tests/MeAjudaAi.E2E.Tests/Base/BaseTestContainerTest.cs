        ...
        _factory = new WebApplicationFactory<Program>()
            .WithWebHostBuilder(builder =>
            {
                ...
                builder.ConfigureServices(services =>
                {
                    ...
                    ReconfigureDbContextWithUnitOfWork<RatingsDbContext>(services);
                    ReconfigureDbContext<DocumentsDbContext>(services);
                    ReconfigureDbContextWithUnitOfWork<ServiceCatalogsDbContext>(services);
                    ...
                    ReconfigureDbContext<CommunicationsDbContext>(services);
                    ...
                    var userDomainServiceDescriptor = services.SingleOrDefault(d => d.ServiceType == typeof(IUserDomainService));
                    ...
                    {
                        ReplaceService<IMessageBus, SynchronousInMemoryMessageBus>(services, ServiceLifetime.Singleton);
                        ReplaceService<IDomainEventProcessor, DomainEventProcessor>(services, ServiceLifetime.Scoped);
                    }
                    else
                    {
                        ReplaceService<IMessageBus, MockMessageBus>(services, ServiceLifetime.Singleton);
                        ReplaceService<IDomainEventProcessor, MockDomainEventProcessor>(services, ServiceLifetime.Scoped);
                    }
