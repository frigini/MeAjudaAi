...
## ✅ Sprint 12 - Bookings & Messaging Excellence (Concluída em 27 Abr 2026)
...
- ✅ **Messaging Excellence**: Migração parcial para Rebus v3 e implementação de atributos `[DedicatedTopic]`, `[HighVolumeEvent]` e `[CriticalEvent]` para roteamento avançado.
    - **Nota Técnica**: Consolidação completa do RabbitMQ pendente (RabbitMqInfrastructureManager ainda utiliza stubs).
