...
{
    private readonly DbSet<TMessage> _dbSet = dbContext.Set<TMessage>() ?? throw new ArgumentNullException(nameof(dbContext));
    ...
    public async Task<IReadOnlyList<TMessage>> GetPendingAsync(
        int batchSize = 20,
