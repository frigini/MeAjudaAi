    ...
    private async Task SeedProvidersAsync(CancellationToken cancellationToken)
    {
        ...
        var providers = new[]
        {
            ...
            new
            {
                ...
                DocumentType = "CNPJ",
                AdditionalPhoneNumbers = new string[0]
            },
            new
            {
                Id = Provider3Id,
