...
public class RemoveDocumentCommandHandlerTests
{
    ...
    public RemoveDocumentCommandHandlerTests()
    {
        ...
        _handler = new RemoveDocumentCommandHandler(_uowMock.Object, _loggerMock.Object, _localizerMock.Object);
    }
    ...
    [Fact]
    public async Task HandleAsync_WhenDocumentNotFound_ShouldThrow()
    {
        // Arrange
        var providerId = Guid.NewGuid();
