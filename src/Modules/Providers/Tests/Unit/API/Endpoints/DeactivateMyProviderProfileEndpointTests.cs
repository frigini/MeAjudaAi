...
[Trait("Category", "Unit")]
public class DeactivateMyProviderProfileEndpointTests
{
    ...
    public DeactivateMyProviderProfileEndpointTests()
    {
    ...
    [Fact]
    public async Task DeactivateMyProfileAsync_WithValidProvider_ShouldReturnOk()
    {
        // Arrange
        ...
        _commandDispatcherMock
            .Setup(x => x.SendAsync<DeactivateProviderProfileCommand, Result>(
                It.Is<DeactivateProviderProfileCommand>(c => c.ProviderId == providerId && c.UpdatedBy == userId.ToString()), It.IsAny<CancellationToken>()))
            .ReturnsAsync(Result.Success());

        // Act
        var methodInfo = typeof(DeactivateMyProviderProfileEndpoint).GetMethod("DeactivateMyProfileAsync",
        ...
        _commandDispatcherMock.Verify(x => x.SendAsync<DeactivateProviderProfileCommand, Result>(It.IsAny<DeactivateProviderProfileCommand>(), It.IsAny<CancellationToken>()), Times.Once);
    }
    ...
    public async Task DeactivateMyProfileAsync_WhenProviderNotFound_ShouldReturnNotFound()
    {
        ...
        _commandDispatcherMock.Verify(x => x.SendAsync<DeactivateProviderProfileCommand, Result>(It.IsAny<DeactivateProviderProfileCommand>(), It.IsAny<CancellationToken>()), Times.Never);
    }
}
