...
public class ServiceCategoryDeactivatedDomainEventTests
{
    [Fact]
    [Trait("Category", "Unit")]
    public void Constructor_ShouldCreateEventWithCategoryId()
    {
        ...
        domainEvent.EventType.Should().Be(nameof(ServiceCategoryDeactivatedDomainEvent));
    ...
    public void Constructor_ShouldGenerateUniqueIdForEachInstance()
    {
        ...
        // Act
        var event1 = new ServiceCategoryDeactivatedDomainEvent(categoryId);
        var event2 = new ServiceCategoryDeactivatedDomainEvent(categoryId);
