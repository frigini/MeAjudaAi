...
public class ServiceCategoryUpdatedDomainEventTests
{
    [Fact]
    [Trait("Category", "Unit")]
    public void Constructor_ShouldCreateEventWithCategoryId()
    {
        ...
        // Act
        var domainEvent = new ServiceCategoryUpdatedDomainEvent(categoryId);
        ...
        domainEvent.EventType.Should().Be(nameof(ServiceCategoryUpdatedDomainEvent));
    ...
    public void Constructor_ShouldGenerateUniqueIdForEachInstance()
    {
        ...
        // Act
        var event1 = new ServiceCategoryUpdatedDomainEvent(categoryId);
        var event2 = new ServiceCategoryUpdatedDomainEvent(categoryId);
