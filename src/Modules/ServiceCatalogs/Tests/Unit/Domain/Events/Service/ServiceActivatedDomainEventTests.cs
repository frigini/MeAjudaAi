...
public class ServiceActivatedDomainEventTests
{
    [Fact]
    [Trait("Category", "Unit")]
    public void Constructor_ShouldCreateEventWithServiceId()
    {
        ...
        domainEvent.EventType.Should().Be(nameof(ServiceActivatedDomainEvent));
    ...
    public void Constructor_ShouldGenerateUniqueIdForEachInstance()
    {
        ...
        // Act
        var event1 = new ServiceActivatedDomainEvent(serviceId);
        var event2 = new ServiceActivatedDomainEvent(serviceId);
