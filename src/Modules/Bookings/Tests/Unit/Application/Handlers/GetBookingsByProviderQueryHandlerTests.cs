...
public class GetBookingsByProviderQueryHandlerTests : BaseUnitTest
{
    ...
    public async Task HandleAsync_Should_Use_Provider_TimeZone()
    {
        ...
        var booking = new BookingBuilder()
            ...
            .WithServiceId(Guid.NewGuid())
            .WithDate(date)
            .WithTimeSlot(new TimeSlotBuilder().WithStart(startTime).WithEnd(endTime).Build())
            .Build();
        ...
        var schedule = new ProviderScheduleBuilder()
            .WithProviderId(providerId)
            .WithTimeZoneId("Tokyo Standard Time")
            .Build();
        ...
        dto!.StartTime.Hour.Should().Be(10);
        dto!.EndTime.Hour.Should().Be(11);
    }
