...
/// <summary>
/// Validator para CreateAllowedCityCommand
/// </summary>
public class CreateAllowedCityCommandValidator : AbstractValidator<CreateAllowedCityCommand>
{
    public CreateAllowedCityCommandValidator()
    {
