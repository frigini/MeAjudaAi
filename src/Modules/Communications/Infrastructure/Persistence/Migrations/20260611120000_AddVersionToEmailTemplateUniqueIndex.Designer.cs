...
namespace MeAjudaAi.Modules.Communications.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260611120000_AddVersionToEmailTemplateUniqueIndex")]
    partial class AddVersionToEmailTemplateUniqueIndex
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MeAjudaAi.Modules.Communications.Domain.Entities.EmailTemplate", b =>
                {
                    ...
                    b.HasIndex("TemplateKey", "Language", "OverrideKey", "Version")
                        .IsUnique()
                        .HasDatabaseName("ix_email_templates_template_key_language_override_key_version");

                    NpgsqlIndexBuilderExtensions.AreNullsDistinct(b.HasIndex("TemplateKey", "Language", "OverrideKey", "Version"), false);
