 ...
 */
export const apiProvidersGetOptions = (options?: Options<ApiProvidersGetData>) => queryOptions<unknown, DefaultError, unknown, ReturnType<typeof apiProvidersGetQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
 ...
 */
export const apiProvidersGet2Options = (options?: Options<ApiProvidersGet2Data>) => queryOptions<ApiProvidersGet2Response, ApiProvidersGet2Error, ApiProvidersGet2Response, ReturnType<typeof apiProvidersGet2QueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
 ...
 */
export const apiProvidersGet3Options = (options: Options<ApiProvidersGet3Data>) => queryOptions<ApiProvidersGet3Response, DefaultError, ApiProvidersGet3Response, ReturnType<typeof apiProvidersGet3QueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
...
export const apiProvidersGet4QueryKey = (options: Options<ApiProvidersGet4Data>) => createQueryKey('apiProvidersGet4', options);
 ...
 */
export const apiProvidersGet4Options = (options: Options<ApiProvidersGet4Data>) => queryOptions<ApiProvidersGet4Response, ApiProvidersGet4Error, ApiProvidersGet4Response, ReturnType<typeof apiProvidersGet4QueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
...
export const apiProvidersGet4InfiniteQueryKey = (options: Options<ApiProvidersGet4Data>): QueryKey<Options<ApiProvidersGet4Data>> => createQueryKey('apiProvidersGet4', options, true);
 ...
 * - Filtrar por avaliação mínima ou nível de assinatura
 */
export const apiProvidersGet4InfiniteOptions = (options: Options<ApiProvidersGet4Data>) => infiniteQueryOptions<ApiProvidersGet4Response, ApiProvidersGet4Error, InfiniteData<ApiProvidersGet4Response>, QueryKey<Options<ApiProvidersGet4Data>>, number | Pick<QueryKey<Options<ApiProvidersGet4Data>>[0], 'body' | 'headers' | 'path' | 'query'>>(
// @ts-ignore
{
    queryFn: async ({ pageParam, queryKey, signal }) => {
        // @ts-ignore
        const page: Pick<QueryKey<Options<ApiProvidersGet4Data>>[0], 'body' | 'headers' | 'path' | 'query'> = typeof pageParam === 'object' ? pageParam : {
            query: {
                page: pageParam
            }
        };
 ...
 * **Permissões:** Requer privilégios de administrador
 */
export const apiActivatePost3Mutation = (options?: Partial<Options<ApiActivatePost3Data>>): UseMutationOptions<ApiActivatePost3Response, DefaultError, Options<ApiActivatePost3Data>> => {
    const mutationOptions: UseMutationOptions<ApiActivatePost3Response, DefaultError, Options<ApiActivatePost3Data>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await apiActivatePost3({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
 ...
 * **Permissões:** Requer privilégios de administrador
 */
export const apiDeactivatePost3Mutation = (options?: Partial<Options<ApiDeactivatePost3Data>>): UseMutationOptions<ApiDeactivatePost3Response, DefaultError, Options<ApiDeactivatePost3Data>> => {
    const mutationOptions: UseMutationOptions<ApiDeactivatePost3Response, DefaultError, Options<ApiDeactivatePost3Data>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await apiDeactivatePost3({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
