...
const mockProviders = [
  { id: "1", name: "João Silva", email: "joao@email.com", phone: "(11) 99999-9999", type: "Pessoa Física", status: "Aprovado", city: "São Paulo" },
  { id: "2", name: "Maria Santos", email: "maria@email.com", phone: "(11) 88888-8888", type: "Pessoa Física", status: "Pendente", city: "Campinas" },
  { id: "3", name: "Tech Solutions Ltda", email: "contato@techsolutions.com", phone: "(11) 77777-7777", type: "Empresa", status: "Aprovado", city: "São Paulo" },
];
  ...
  return (
    <div className="p-8">
      ...
      <Card>
            ...
            <tbody>
              {filteredProviders.map((provider) => (
                <tr key={provider.id} className="border-b border-border last:border-b-0">
                  ...
                  <td className="px-4 py-3"><Badge variant={statusVariant(provider.status)}>{provider.status}</Badge></td>
        ...
        {filteredProviders.length === 0 && <div className="p-8 text-center text-muted-foreground">Nenhum prestador encontrado</div>}
      </Card>
    </div>
  );
}
